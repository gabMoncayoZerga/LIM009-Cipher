window.cipher = {
  encode: (encodeOffset, textToEncode) => {
    let valueOfTextToEncode = textToEncode;
    let offset= encodeOffset;
    let palabra = "";
...
decode: (decodeOffset, textToDecode) => {
  let valueOfTextToDecode = textToDecode; //A
